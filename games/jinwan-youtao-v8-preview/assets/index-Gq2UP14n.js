...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Wn,depthTest:!1,depthWrite:!1})}function Gm(n,e,t){const i=new Float32Array(yi),s=new G(0,1,0);return new In({name:"SphericalGaussianBlur",defines:{n:yi,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:Vr(),fragmentShader:`
		...
		`,blending:Wn,depthTest:!1,depthWrite:!1})}function uc(){return new In({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Vr(),fragmentShader:`
		...
		`,blending:Wn,depthTest:!1,depthWrite:!1})}function dc(){return new In({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Vr(),fragmentShader:`
	...
	`}class Ru extends Cn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const i={width:e,height:e,depth:1},s=[i,i,i,i,i,i];this.texture=new Mu(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},s=new gs(5,5,5),r=new In({name:"CubemapFromEquirect",uniforms:hs(i.uniforms),vertexShader:i.vertexShader,fragmentShader:i.fragmentShader,side:Wt,blending:Wn});r.uniforms.tEquirect.value=t;const a=new wt(s,r),o=t.minFilter;return t.minFilter===Ti&&(t.minFilter=Ut),new Xf(1,10,this).update(e,a),t.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(e,t=!0,i=!0,s=!0){const r=e.getRenderTarget();for(let a=0;a<6;a++)e.setRenderTarget(this,a),e.clear(t,i,s);e.setRenderTarget(r)}}function Hm(n){let e=new WeakMap,t=new WeakMap,i=null;function s(d,p=!1){return d==null?null:p?a(d):r(d)}function r(d){if(d&&d.isTexture){const p=d.mapping;if(p===Zr||p===Jr)if(e.has(d)){const m=e.get(d).texture;return o(m,d.mapping)}else{const m=d.image;if(m&&m.height>0){const x=new Ru(m.height);return x.fromEquirectangularTexture(n,d),e.set(d,x),d.addEventListener("dispose",c),o(x.texture,d.mapping)}else return null}}return d}function a(d){if(d&&d.isTexture){const p=d.mapping,m=p===Zr||p===Jr,x=p===Ci||p===ds;if(m||x){let g=t.get(d);const h=g!==void 0?g.texture.pmremVersion:0;if(d.isRenderTargetTexture&&d.pmremVersion!==h)return i===null&&(i=new lc(n)),g=m?i.fromEquirectangular(d,g):i.fromCubemap(d,g),g.texture.pmremVersion=d.pmremVersion,t.set(d,g),g.texture;if(g!==void 0)return g.texture;{const w=d.image;return m&&w&&w.height>0||x&&w&&l(w)?(i===null&&(i=new lc(n)),g=m?i.fromEquirectangular(d):i.fromCubemap(d),g.texture.pmremVersion=d.pmremVersion,t.set(d,g),d.addEventListener("dispose",u),g.texture):null}}}return d}function o(d,p){return p===Zr?d.mapping=Ci:p===Jr&&(d.mapping=ds),d}function l(d){let p=0;const m=6;for(let x=0;x<m;x++)d[x]!==void 0&&p++;return p===m}function c(d){const p=d.target;p.removeEventListener("dispose",c);const m=e.get(p);m!==void 0&&(e.delete(p),m.dispose())}function u(d){const p=d.target;p.removeEventListener("dispose",u);const m=t.get(p);m!==void 0&&(t.delete(p),m.dispose())}function f(){e=new WeakMap,t=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:s,dispose:f}}function Vm(n){const e={};function t(i){if(e[i]!==void 0)return e[i];const s=n.getExtension(i);return e[i]=s,s}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){const s=t(i);return s===null&&os("WebGLRenderer: "+i+" extension not supported."),s}}}function Wm(n,e,t,i){const s={},r=new WeakMap;function a(f){const d=f.target;d.index!==null&&e.remove(d.index);for(const m in d.attributes)e.remove(d.attributes[m]);d.removeEventListener("dispose",a),delete s[d.id];const p=r.get(d);p&&(e.remove(p),r.delete(d)),i.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function o(f,d){return s[d.id]===!0||(d.addEventListener("dispose",a),s[d.id]=!0,t.memory.geometries++),d}function l(f){const d=f.attributes;for(const p in d)e.update(d[p],n.ARRAY_BUFFER)}function c(f){const d=[],p=f.index,m=f.attributes.position;let x=0;if(m===void 0)return;if(p!==null){const w=p.array;x=p.version;for(let P=0,b=w.length;P<b;P+=3){const R=w[P+0],A=w[P+1],C=w[P+2];d.push(R,A,A,C,C,R)}}else{const w=m.array;x=m.version;for(let P=0,b=w.length/3-1;P<b;P+=3){const R=P+0,A=P+1,C=P+2;d.push(R,A,A,C,C,R)}}const g=new(m.count>=65535?_u:gu)(d,1);g.version=x;const h=r.get(f);h&&e.remove(h),r.set(f,g)}function u(f){const d=r.get(f);if(d){const p=f.index;p!==null&&d.version<p.version&&c(f)}else c(f);return r.get(f)}return{get:o,update:l,getWireframeAttribute:u}}function $m(n,e,t){let i;function s(f){i=f}let r,a;function o(f){r=f.type,a=f.bytesPerElement}function l(f,d){n.drawElements(i,d,r,f*a),t.update(d,i,1)}function c(f,d,p){p!==0&&(n.drawElementsInstanced(i,d,r,f*a,p),t.update(d,i,p))}function u(f,d,p){if(p===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,d,0,r,f,0,p);let x=0;for(let g=0;g<p;g++)x+=d[g];t.update(x,i,1)}this.setMode=s,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=u}function Xm(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(r,a,o){switch(t.calls++,a){case n.TRIANGLES:t.triangles+=o*(r/3);break;case n.LINES:t.lines+=o*(r/2);break;case n.LINE_STRIP:t.lines+=o*(r-1);break;case n.LINE_LOOP:t.lines+=o*r;break;case n.POINTS:t.points+=o*r;break;default:Xe("WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:i}}function qm(n,e,t){const i=new WeakMap,s=new lt;function r(a,o,l){const c=a.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,f=u!==void 0?u.length:0;let d=i.get(o);if(d===void 0||d.count!==f){let I=function(){v.dispose(),i.delete(o),o.removeEventListener("dispose",I)};var p=I;d!==void 0&&d.texture.dispose();const m=o.morphAttributes.position!==void 0,x=o.morphAttributes.normal!==void 0,g=o.morphAttributes.color!==void 0,h=o.morphAttributes.position||[],w=o.morphAttributes.normal||[],P=o.morphAttributes.color||[];let b=0;m===!0&&(b=1),x===!0&&(b=2),g===!0&&(b=3);let R=o.attributes.position.count*b,A=1;R>e.maxTextureSize&&(A=Math.ceil(R/e.maxTextureSize),R=e.maxTextureSize);const C=new Float32Array(R*A*4*f),v=new pu(C,R,A,f);v.type=cn,v.needsUpdate=!0;const T=b*4;for(let D=0;D<f;D++){const N=h[D],Y=w[D],Q=P[D],H=R*A*4*D;for(let J=0;J<N.count;J++){const X=J*T;m===!0&&(s.fromBufferAttribute(N,J),C[H+X+0]=s.x,C[H+X+1]=s.y,C[H+X+2]=s.z,C[H+X+3]=0),x===!0&&(s.fromBufferAttribute(Y,J),C[H+X+4]=s.x,C[H+X+5]=s.y,C[H+X+6]=s.z,C[H+X+7]=0),g===!0&&(s.fromBufferAttribute(Q,J),C[H+X+8]=s.x,C[H+X+9]=s.y,C[H+X+10]=s.z,C[H+X+11]=Q.itemSize===4?s.w:1)}}d={count:f,texture:v,size:new Ve(R,A)},i.set(o,d),o.addEventListener("dispose",I)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(n,"morphTexture",a.morphTexture,t);else{let m=0;for(let g=0;g<c.length;g++)m+=c[g];const x=o.morphTargetsRelative?1:1-m;l.getUniforms().setValue(n,"morphTargetBaseInfluence",x),l.getUniforms().setValue(n,"morphTargetInfluences",c)}l.getUniforms().setValue(n,"morphTargetsTexture",d.texture,t),l.getUniforms().setValue(n,"morphTargetsTextureSize",d.size)}return{update:r}}function Ym(n,e,t,i,s){let r=new WeakMap;function a(c){const u=s.render.frame,f=c.geometry,d=e.get(c,f);if(r.get(d)!==u&&(e.update(d),r.set(d,u)),c.isInstancedMesh&&(c.hasEventListener("dispose",l)===!1&&c.addEventListener("dispose",l),r.get(c)!==u&&(t.update(c.instanceMatrix,n.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,n.ARRAY_BUFFER),r.set(c,u))),c.isSkinnedMesh){const p=c.skeleton;r.get(p)!==u&&(p.update(),r.set(p,u))}return d}function o(){r=new WeakMap}function l(c){const u=c.target;u.removeEventListener("dispose",l),i.releaseStatesOfObject(u),t.remove(u.instanceMatrix),u.instanceColor!==null&&t.remove(u.instanceColor)}return{update:a,dispose:o}}const Km={[eu]:"LINEAR_TONE_MAPPING",[tu]:"REINHARD_TONE_MAPPING",[nu]:"CINEON_TONE_MAPPING",[Yo]:"ACES_FILMIC_TONE_MAPPING",[su]:"AGX_TONE_MAPPING",[ru]:"NEUTRAL_TONE_MAPPING",[iu]:"CUSTOM_TONE_MAPPING"};function Zm(n,e,t,i,s,r){const a=new Cn(e,t,{type:n,depthBuffer:s,stencilBuffer:r,samples:i?4:0,depthTexture:s?new fs(e,t):void 0}),o=new Cn(e,t,{type:Xn,depthBuffer:!1,stencilBuffer:!1}),l=new pn;l.setAttribute("position",new Bt([-1,3,0,-1,-1,0,3,-1,0],3)),l.setAttribute("uv",new Bt([0,2,0,0,2,0],2));const c=new Bf({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),u=new wt(l,c),f=new Hr(-1,1,1,-1,0,1);let d=null,p=null,m=!1,x,g=null,h=[],w=!1;this.setSize=function(P,b){a.setSize(P,b),o.setSize(P,b);for(let R=0;R<h.length;R++){const A=h[R];A.setSize&&A.setSize(P,b)}},this.setEffects=function(P){h=P,w=h.length>0&&h[0].isRenderPass===!0;const b=a.width,R=a.height;for(let A=0;A<h.length;A++){const C=h[A];C.setSize&&C.setSize(b,R)}},this.begin=function(P,b){if(m||P.toneMapping===Rn&&h.length===0)return!1;if(g=b,b!==null){const R=b.width,A=b.height;(a.width!==R||a.height!==A)&&this.setSize(R,A)}return w===!1&&P.setRenderTarget(a),x=P.toneMapping,P.toneMapping=Rn,!0},this.hasRenderPass=function(){return w},this.end=function(P,b){P.toneMapping=x,m=!0;let R=a,A=o;for(let C=0;C<h.length;C++){const v=h[C];if(v.enabled!==!1&&(v.render(P,A,R,b),v.needsSwap!==!1)){const T=R;R=A,A=T}}if(d!==P.outputColorSpace||p!==P.toneMapping){d=P.outputColorSpace,p=P.toneMapping,c.defines={},We.getTransfer(d)===et&&(c.defines.SRGB_TRANSFER="");const C=Km[p];C&&(c.defines[C]=""),c.needsUpdate=!0}c.uniforms.tDiffuse.value=R.texture,P.setRenderTarget(g),P.render(u,f),g=null,m=!1},this.isCompositing=function(){return m},this.dispose=function(){a.depthTexture&&a.depthTexture.dispose(),a.dispose(),o.dispose(),l.dispose(),c.dispose()}}const Cu=new kt,No=new fs(1,1),Pu=new pu,Iu=new gf,Lu=new Mu,fc=[],hc=[],pc=new Float32Array(16),mc=new Float32Array(9),gc=new Float32Array(4);function vs(n,e,t){const i=n[0];if(i<=0||i>0)return n;const s=e*t;let r=fc[s];if(r===void 0&&(r=new Float32Array(s),fc[s]=r),e!==0){i.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,n[a].toArray(r,o)}return r}function yt(n,e){if(n.length!==e.length)return!1;for(let t=0,i=n.length;t<i;t++)if(n[t]!==e[t])return!1;return!0}function St(n,e){for(let t=0,i=e.length;t<i;t++)n[t]=e[t]}function Wr(n,e){let t=hc[e];t===void 0&&(t=new Int32Array(e),hc[e]=t);for(let i=0;i!==e;++i)t[i]=n.allocateTextureUnit();return t}function Jm(n,e){const t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function Qm(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(yt(t,e))return;n.uniform2fv(this.addr,e),St(t,e)}}function jm(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(yt(t,e))return;n.uniform3fv(this.addr,e),St(t,e)}}function e0(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(yt(t,e))return;n.uniform4fv(this.addr,e),St(t,e)}}function t0(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(yt(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),St(t,e)}else{if(yt(t,i))return;gc.set(i),n.uniformMatrix2fv(this.addr,!1,gc),St(t,i)}}function n0(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(yt(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),St(t,e)}else{if(yt(t,i))return;mc.set(i),n.uniformMatrix3fv(this.addr,!1,mc),St(t,i)}}function i0(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(yt(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),St(t,e)}else{if(yt(t,i))return;pc.set(i),n.uniformMatrix4fv(this.addr,!1,pc),St(t,i)}}function s0(n,e){const t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function r0(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(yt(t,e))return;n.uniform2iv(this.addr,e),St(t,e)}}function a0(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(yt(t,e))return;n.uniform3iv(this.addr,e),St(t,e)}}function o0(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(yt(t,e))return;n.uniform4iv(this.addr,e),St(t,e)}}function l0(n,e){const t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function c0(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(yt(t,e))return;n.uniform2uiv(this.addr,e),St(t,e)}}function u0(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(yt(t,e))return;n.uniform3uiv(this.addr,e),St(t,e)}}function d0(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(yt(t,e))return;n.uniform4uiv(this.addr,e),St(t,e)}}function f0(n,e,t){const i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s);let r;this.type===n.SAMPLER_2D_SHADOW?(No.compareFunction=t.isReversedDepthBuffer()?il:nl,r=No):r=Cu,t.setTexture2D(e||r,s)}function h0(n,e,t){const i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),t.setTexture3D(e||Iu,s)}function p0(n,e,t){const i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),t.setTextureCube(e||Lu,s)}function m0(n,e,t){const i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),t.setTexture2DArray(e||Pu,s)}function g0(n){switch(n){case 5126:return Jm;case 35664:return Qm;case 35665:return jm;case 35666:return e0;case 35674:return t0;case 35675:return n0;case 35676:return i0;case 5124:case 35670:return s0;case 35667:case 35671:return r0;case 35668:case 35672:return a0;case 35669:case 35673:return o0;case 5125:return l0;case 36294:return c0;case 36295:return u0;case 36296:return d0;case 35678:case 36198:case 36298:case 36306:case 35682:return f0;case 35679:case 36299:case 36307:return h0;case 35680:case 36300:case 36308:case 36293:return p0;case 36289:case 36303:case 36311:case 36292:return m0}}function _0(n,e){n.uniform1fv(this.addr,e)}function v0(n,e){const t=vs(e,this.size,2);n.uniform2fv(this.addr,t)}function x0(n,e){const t=vs(e,this.size,3);n.uniform3fv(this.addr,t)}function M0(n,e){const t=vs(e,this.size,4);n.uniform4fv(this.addr,t)}function b0(n,e){const t=vs(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function y0(n,e){const t=vs(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function S0(n,e){const t=vs(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function E0(n,e){n.uniform1iv(this.addr,e)}function T0(n,e){n.uniform2iv(this.addr,e)}function A0(n,e){n.uniform3iv(this.addr,e)}function w0(n,e){n.uniform4iv(this.addr,e)}function R0(n,e){n.uniform1uiv(this.addr,e)}function C0(n,e){n.uniform2uiv(this.addr,e)}function P0(n,e){n.uniform3uiv(this.addr,e)}function I0(n,e){n.uniform4uiv(this.addr,e)}function L0(n,e,t){const i=this.cache,s=e.length,r=Wr(t,s);yt(i,r)||(n.uniform1iv(this.addr,r),St(i,r));let a;this.type===n.SAMPLER_2D_SHADOW?a=No:a=Cu;for(let o=0;o!==s;++o)t.setTexture2D(e[o]||a,r[o])}function D0(n,e,t){const i=this.cache,s=e.length,r=Wr(t,s);yt(i,r)||(n.uniform1iv(this.addr,r),St(i,r));for(let a=0;a!==s;++a)t.setTexture3D(e[a]||Iu,r[a])}function U0(n,e,t){const i=this.cache,s=e.length,r=Wr(t,s);yt(i,r)||(n.uniform1iv(this.addr,r),St(i,r));for(let a=0;a!==s;++a)t.setTextureCube(e[a]||Lu,r[a])}function N0(n,e,t){const i=this.cache,s=e.length,r=Wr(t,s);yt(i,r)||(n.uniform1iv(this.addr,r),St(i,r));for(let a=0;a!==s;++a)t.setTexture2DArray(e[a]||Pu,r[a])}function F0(n){switch(n){case 5126:return _0;case 35664:return v0;case 35665:return x0;case 35666:return M0;case 35674:return b0;case 35675:return y0;case 35676:return S0;case 5124:case 35670:return E0;case 35667:case 35671:return T0;case 35668:case 35672:return A0;case 35669:case 35673:return w0;case 5125:return R0;case 36294:return C0;case 36295:return P0;case 36296:return I0;case 35678:case 36198:case 36298:case 36306:case 35682:return L0;case 35679:case 36299:case 36307:return D0;case 35680:case 36300:case 36308:case 36293:return U0;case 36289:case 36303:case 36311:case 36292:return N0}}class O0{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=g0(t.type)}}class k0{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=F0(t.type)}}class B0{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const s=this.seq;for(let r=0,a=s.length;r!==a;++r){const o=s[r];o.setValue(e,t[o.id],i)}}}const Ra=/(\w+)(\])?(\[|\.)?/g;function _c(n,e){n.seq.push(e),n.map[e.id]=e}function z0(n,e,t){const i=n.name,s=i.length;for(Ra.lastIndex=0;;){const r=Ra.exec(i),a=Ra.lastIndex;let o=r[1];const l=r[2]==="]",c=r[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===s){_c(t,c===void 0?new O0(o,n,e):new k0(o,n,e));break}else{let f=t.map[o];f===void 0&&(f=new B0(o),_c(t,f)),t=f}}}class Tr{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let a=0;a<i;++a){const o=e.getActiveUniform(t,a),l=e.getUniformLocation(t,o.name);z0(o,l,this)}const s=[],r=[];for(const a of this.seq)a.type===e.SAMPLER_2D_SHADOW||a.type===e.SAMPLER_CUBE_SHADOW||a.type===e.SAMPLER_2D_ARRAY_SHADOW?s.push(a):r.push(a);s.length>0&&(this.seq=s.concat(r))}setValue(e,t,i,s){const r=this.map[t];r!==void 0&&r.setValue(e,i,s)}setOptional(e,t,i){const s=t[i];s!==void 0&&this.setValue(e,i,s)}static upload(e,t,i,s){for(let r=0,a=t.length;r!==a;++r){const o=t[r],l=i[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,s)}}static seqWithValue(e,t){const i=[];for(let s=0,r=e.length;s!==r;++s){const a=e[s];a.id in t&&i.push(a)}return i}}function vc(n,e,t){const i=n.createShader(e);return n.shaderSource(i,t),n.compileShader(i),i}const G0=37297;let H0=0;function V0(n,e){const t=n.split(`
`),i=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=s;a<r;a++){const o=a+1;i.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return i.join(`
`)}const xc=new Ue;function W0(n){We._getMatrix(xc,We.workingColorSpace,n);const e=`mat3( ${xc.elements.map(t=>t.toFixed(4))} )`;switch(We.getTransfer(n)){case Ur:return[e,"LinearTransferOETF"];case et:return[e,"sRGBTransferOETF"];default:return De("WebGLProgram: Unsupported color space: ",n),[e,"LinearTransferOETF"]}}function Mc(n,e,t){const i=n.getShaderParameter(e,n.COMPILE_STATUS),r=(n.getShaderInfoLog(e)||"").trim();if(i&&r==="")return"";const a=/ERROR: 0:(\d+)/.exec(r);if(a){const o=parseInt(a[1]);return t.toUpperCase()+`

`+r+`

`+V0(n.getShaderSource(e),o)}else return r}function $0(n,e){const t=W0(e);return[`vec4 ${n}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}const X0={[eu]:"Linear",[tu]:"Reinhard",[nu]:"Cineon",[Yo]:"ACESFilmic",[su]:"AgX",[ru]:"Neutral",[iu]:"Custom"};function q0(n,e){const t=X0[e];return t===void 0?(De("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const vr=new G;function Y0(){We.getLuminanceCoefficients(vr);const n=vr.x.toFixed(4),e=vr.y.toFixed(4),t=vr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function K0(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",n.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Is).join(`
`)}function Z0(n){const e=[];for(const t in n){const i=n[t];i!==!1&&e.push("#define "+t+" "+i)}return e.join(`
`)}function J0(n,e){const t={},i=n.getProgramParameter(e,n.ACTIVE_ATTRIBUTES);for(let s=0;s<i;s++){const r=n.getActiveAttrib(e,s),a=r.name;let o=1;r.type===n.FLOAT_MAT2&&(o=2),r.type===n.FLOAT_MAT3&&(o=3),r.type===n.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:n.getAttribLocation(e,a),locationSize:o}}return t}function Is(n){return n!==""}function bc(n,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function yc(n,e){return n.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Q0=/^[ \t]*#include +<([\w\d./]+)>/gm;function Fo(n){return n.replace(Q0,eg)}const j0=new Map;function eg(n,e){let t=Be[e];if(t===void 0){const i=j0.get(e);if(i!==void 0)t=Be[i],De('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("THREE.WebGLProgram: Can not resolve #include <"+e+">")}return Fo(t)}const tg=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Sc(n){return n.replace(tg,ng)}function ng(n,e,t,i){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=i.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Ec(n){let e=`precision ${n.precision} float;
...
#define LOW_PRECISION`),e}const ig={[Mr]:"SHADOWMAP_TYPE_PCF",[Ps]:"SHADOWMAP_TYPE_VSM"};function sg(n){return ig[n.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const rg={[Ci]:"ENVMAP_TYPE_CUBE",[ds]:"ENVMAP_TYPE_CUBE",[Br]:"ENVMAP_TYPE_CUBE_UV"};function ag(n){return n.envMap===!1?"ENVMAP_TYPE_CUBE":rg[n.envMapMode]||"ENVMAP_TYPE_CUBE"}const og={[ds]:"ENVMAP_MODE_REFRACTION"};function lg(n){return n.envMap===!1?"ENVMAP_MODE_REFLECTION":og[n.envMapMode]||"ENVMAP_MODE_REFLECTION"}const cg={[jc]:"ENVMAP_BLENDING_MULTIPLY",[Yd]:"ENVMAP_BLENDING_MIX",[Kd]:"ENVMAP_BLENDING_ADD"};function ug(n){return n.envMap===!1?"ENVMAP_BLENDING_NONE":cg[n.combine]||"ENVMAP_BLENDING_NONE"}function dg(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:i,maxMip:t}}function fg(n,e,t,i){const s=n.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=sg(t),c=ag(t),u=lg(t),f=ug(t),d=dg(t),p=K0(t),m=Z0(r),x=s.createProgram();let g,h,w=t.glslVersion?"#version "+t.glslVersion+`
...
}`,Cg=[new G(1,0,0),new G(-1,0,0),new G(0,1,0),new G(0,-1,0),new G(0,0,1),new G(0,0,-1)],Pg=[new G(0,-1,0),new G(0,-1,0),new G(0,0,1),new G(0,0,-1),new G(0,-1,0),new G(0,-1,0)],Rc=new rt,ws=new G,Ca=new G;function Ig(n,e,t){let i=new ol;const s=new Ve,r=new Ve,a=new lt,o=new zf,l=new Gf,c={},u=t.maxTextureSize,f={[hi]:Wt,[Wt]:hi,[Bn]:Bn},d=new In({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ve},radius:{value:4}},vertexShader:wg,fragmentShader:Rg}),p=d.clone();p.defines.HORIZONTAL_PASS=1;const m=new pn;m.setAttribute("position",new hn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new wt(m,d),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Mr;let h=this.type;this.render=function(A,C,v){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||A.length===0)return;this.type===Qc&&(De("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Mr);const T=n.getRenderTarget(),I=n.getActiveCubeFace(),D=n.getActiveMipmapLevel(),N=n.state;N.setBlending(Wn),N.buffers.depth.getReversed()===!0?N.buffers.color.setClear(0,0,0,0):N.buffers.color.setClear(1,1,1,1),N.buffers.depth.setTest(!0),N.setScissorTest(!1);const Y=h!==this.type;Y&&C.traverse(function(Q){Q.material&&(Array.isArray(Q.material)?Q.material.forEach(H=>H.needsUpdate=!0):Q.material.needsUpdate=!0)});for(let Q=0,H=A.length;Q<H;Q++){const J=A[Q],X=J.shadow;if(X===void 0){De("WebGLShadowMap:",J,"has no shadow.");continue}if(X.autoUpdate===!1&&X.needsUpdate===!1)continue;s.copy(X.mapSize);const ie=X.getFrameExtents();s.multiply(ie),r.copy(X.mapSize),(s.x>u||s.y>u)&&(s.x>u&&(r.x=Math.floor(u/ie.x),s.x=r.x*ie.x,X.mapSize.x=r.x),s.y>u&&(r.y=Math.floor(u/ie.y),s.y=r.y*ie.y,X.mapSize.y=r.y));const oe=n.state.buffers.depth.getReversed();if(X.camera._reversedDepth=oe,X.map===null||Y===!0){if(X.map!==null&&(X.map.depthTexture!==null&&(X.map.depthTexture.dispose(),X.map.depthTexture=null),X.map.dispose()),this.type===Ps){if(J.isPointLight){De("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}X.map=new Cn(s.x,s.y,{format:Pi,type:Xn,minFilter:Ut,magFilter:Ut,generateMipmaps:!1}),X.map.texture.name=J.name+".shadowMap",X.map.depthTexture=new fs(s.x,s.y,cn),X.map.depthTexture.name=J.name+".shadowMapDepth",X.map.depthTexture.format=qn,X.map.depthTexture.compareFunction=null,X.map.depthTexture.minFilter=Ct,X.map.depthTexture.magFilter=Ct}else J.isPointLight?(X.map=new Ru(s.x),X.map.depthTexture=new Uf(s.x,Pn)):(X.map=new Cn(s.x,s.y),X.map.depthTexture=new fs(s.x,s.y,Pn)),X.map.depthTexture.name=J.name+".shadowMap",X.map.depthTexture.format=qn,this.type===Mr?(X.map.depthTexture.compareFunction=oe?il:nl,X.map.depthTexture.minFilter=Ut,X.map.depthTexture.magFilter=Ut):(X.map.depthTexture.compareFunction=null,X.map.depthTexture.minFilter=Ct,X.map.depthTexture.magFilter=Ct);X.camera.updateProjectionMatrix()}const k=X.map.isWebGLCubeRenderTarget?6:1;for(let B=0;B<k;B++){if(X.map.isWebGLCubeRenderTarget)n.setRenderTarget(X.map,B),n.clear();else{B===0&&(n.setRenderTarget(X.map),n.clear());const E=X.getViewport(B);a.set(r.x*E.x,r.y*E.y,r.x*E.z,r.y*E.w),N.viewport(a)}if(J.isPointLight){const E=X.camera,se=X.matrix,Le=J.distance||E.far;Le!==E.far&&(E.far=Le,E.updateProjectionMatrix()),ws.setFromMatrixPosition(J.matrixWorld),E.position.copy(ws),Ca.copy(E.position),Ca.add(Cg[B]),E.up.copy(Pg[B]),E.lookAt(Ca),E.updateMatrixWorld(),se.makeTranslation(-ws.x,-ws.y,-ws.z),Rc.multiplyMatrices(E.projectionMatrix,E.matrixWorldInverse),X._frustum.setFromProjectionMatrix(Rc,E.coordinateSystem,E.reversedDepth)}else X.updateMatrices(J);i=X.getFrustum(),b(C,v,X.camera,J,this.type)}X.isPointLightShadow!==!0&&this.type===Ps&&w(X,v),X.needsUpdate=!1}h=this.type,g.needsUpdate=!1,n.setRenderTarget(T,I,D)};function w(A,C){const v=e.update(x);d.defines.VSM_SAMPLES!==A.blurSamples&&(d.defines.VSM_SAMPLES=A.blurSamples,p.defines.VSM_SAMPLES=A.blurSamples,d.needsUpdate=!0,p.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new Cn(s.x,s.y,{format:Pi,type:Xn})),d.uniforms.shadow_pass.value=A.map.depthTexture,d.uniforms.resolution.value=A.mapSize,d.uniforms.radius.value=A.radius,n.setRenderTarget(A.mapPass),n.clear(),n.renderBufferDirect(C,null,v,d,x,null),p.uniforms.shadow_pass.value=A.mapPass.texture,p.uniforms.resolution.value=A.mapSize,p.uniforms.radius.value=A.radius,n.setRenderTarget(A.map),n.clear(),n.renderBufferDirect(C,null,v,p,x,null)}function P(A,C,v,T){let I=null;const D=v.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(D!==void 0)I=D;else if(I=v.isPointLight===!0?l:o,n.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){const N=I.uuid,Y=C.uuid;let Q=c[N];Q===void 0&&(Q={},c[N]=Q);let H=Q[Y];H===void 0&&(H=I.clone(),Q[Y]=H,C.addEventListener("dispose",R)),I=H}if(I.visible=C.visible,I.wireframe=C.wireframe,T===Ps?I.side=C.shadowSide!==null?C.shadowSide:C.side:I.side=C.shadowSide!==null?C.shadowSide:f[C.side],I.alphaMap=C.alphaMap,I.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,I.map=C.map,I.clipShadows=C.clipShadows,I.clippingPlanes=C.clippingPlanes,I.clipIntersection=C.clipIntersection,I.displacementMap=C.displacementMap,I.displacementScale=C.displacementScale,I.displacementBias=C.displacementBias,I.wireframeLinewidth=C.wireframeLinewidth,I.linewidth=C.linewidth,v.isPointLight===!0&&I.isMeshDistanceMaterial===!0){const N=n.properties.get(I);N.light=v}return I}function b(A,C,v,T,I){if(A.visible===!1)return;if(A.layers.test(C.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&I===Ps)&&(!A.frustumCulled||i.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(v.matrixWorldInverse,A.matrixWorld);const Y=e.update(A),Q=A.material;if(Array.isArray(Q)){const H=Y.groups;for(let J=0,X=H.length;J<X;J++){const ie=H[J],oe=Q[ie.materialIndex];if(oe&&oe.visible){const k=P(A,oe,T,I);A.onBeforeShadow(n,A,C,v,Y,k,ie),n.renderBufferDirect(v,null,Y,k,A,ie),A.onAfterShadow(n,A,C,v,Y,k,ie)}}}else if(Q.visible){const H=P(A,Q,T,I);A.onBeforeShadow(n,A,C,v,Y,H,null),n.renderBufferDirect(v,null,Y,H,A,null),A.onAfterShadow(n,A,C,v,Y,H,null)}}const N=A.children;for(let Y=0,Q=N.length;Y<Q;Y++)b(N[Y],C,v,T,I)}function R(A){A.target.removeEventListener("dispose",R);for(const v in c){const T=c[v],I=A.target.uuid;I in T&&(T[I].dispose(),delete T[I])}}}function Lg(n,e){function t(){let U=!1;const ue=new lt;let j=null;const pe=new lt(0,0,0,0);return{setMask:function(xe){j!==xe&&!U&&(n.colorMask(xe,xe,xe,xe),j=xe)},setLocked:function(xe){U=xe},setClear:function(xe,re,Ee,ye,ut){ut===!0&&(xe*=ye,re*=ye,Ee*=ye),ue.set(xe,re,Ee,ye),pe.equals(ue)===!1&&(n.clearColor(xe,re,Ee,ye),pe.copy(ue))},reset:function(){U=!1,j=null,pe.set(-1,0,0,0)}}}function i(){let U=!1,ue=!1,j=null,pe=null,xe=null;return{setReversed:function(re){if(ue!==re){const Ee=e.get("EXT_clip_control");re?Ee.clipControlEXT(Ee.LOWER_LEFT_EXT,Ee.ZERO_TO_ONE_EXT):Ee.clipControlEXT(Ee.LOWER_LEFT_EXT,Ee.NEGATIVE_ONE_TO_ONE_EXT),ue=re;const ye=xe;xe=null,this.setClear(ye)}},getReversed:function(){return ue},setTest:function(re){re?ae(n.DEPTH_TEST):Re(n.DEPTH_TEST)},setMask:function(re){j!==re&&!U&&(n.depthMask(re),j=re)},setFunc:function(re){if(ue&&(re=cf[re]),pe!==re){switch(re){case qa:n.depthFunc(n.NEVER);break;case Ya:n.depthFunc(n.ALWAYS);break;case Ka:n.depthFunc(n.LESS);break;case us:n.depthFunc(n.LEQUAL);break;case Za:n.depthFunc(n.EQUAL);break;case Ja:n.depthFunc(n.GEQUAL);break;case Qa:n.depthFunc(n.GREATER);break;case ja:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}pe=re}},setLocked:function(re){U=re},setClear:function(re){xe!==re&&(xe=re,ue&&(re=1-re),n.clearDepth(re))},reset:function(){U=!1,j=null,pe=null,xe=null,ue=!1}}}function s(){let U=!1,ue=null,j=null,pe=null,xe=null,re=null,Ee=null,ye=null,ut=null;return{setTest:function(at){U||(at?ae(n.STENCIL_TEST):Re(n.STENCIL_TEST))},setMask:function(at){ue!==at&&!U&&(n.stencilMask(at),ue=at)},setFunc:function(at,mn,gn){(j!==at||pe!==mn||xe!==gn)&&(n.stencilFunc(at,mn,gn),j=at,pe=mn,xe=gn)},setOp:function(at,mn,gn){(re!==at||Ee!==mn||ye!==gn)&&(n.stencilOp(at,mn,gn),re=at,Ee=mn,ye=gn)},setLocked:function(at){U=at},setClear:function(at){ut!==at&&(n.clearStencil(at),ut=at)},reset:function(){U=!1,ue=null,j=null,pe=null,xe=null,re=null,Ee=null,ye=null,ut=null}}}const r=new t,a=new i,o=new s,l=new WeakMap,c=new WeakMap;let u={},f={},d={},p=new WeakMap,m=[],x=null,g=!1,h=null,w=null,P=null,b=null,R=null,A=null,C=null,v=new qe(0,0,0),T=0,I=!1,D=null,N=null,Y=null,Q=null,H=null;const J=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let X=!1,ie=0;const oe=n.getParameter(n.VERSION);oe.indexOf("WebGL")!==-1?(ie=parseFloat(/^WebGL (\d)/.exec(oe)[1]),X=ie>=1):oe.indexOf("OpenGL ES")!==-1&&(ie=parseFloat(/^OpenGL ES (\d)/.exec(oe)[1]),X=ie>=2);let k=null,B={};const E=n.getParameter(n.SCISSOR_BOX),se=n.getParameter(n.VIEWPORT),Le=new lt().fromArray(E),ce=new lt().fromArray(se);function ee(U,ue,j,pe){const xe=new Uint8Array(4),re=n.createTexture();n.bindTexture(U,re),n.texParameteri(U,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(U,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Ee=0;Ee<j;Ee++)U===n.TEXTURE_3D||U===n.TEXTURE_2D_ARRAY?n.texImage3D(ue,0,n.RGBA,1,1,pe,0,n.RGBA,n.UNSIGNED_BYTE,xe):n.texImage2D(ue+Ee,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,xe);return re}const ne={};ne[n.TEXTURE_2D]=ee(n.TEXTURE_2D,n.TEXTURE_2D,1),ne[n.TEXTURE_CUBE_MAP]=ee(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),ne[n.TEXTURE_2D_ARRAY]=ee(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),ne[n.TEXTURE_3D]=ee(n.TEXTURE_3D,n.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),ae(n.DEPTH_TEST),a.setFunc(us),gt(!1),xt(Al),ae(n.CULL_FACE),Ze(Wn);function ae(U){u[U]!==!0&&(n.enable(U),u[U]=!0)}function Re(U){u[U]!==!1&&(n.disable(U),u[U]=!1)}function Ne(U,ue){return d[U]!==ue?(n.bindFramebuffer(U,ue),d[U]=ue,U===n.DRAW_FRAMEBUFFER&&(d[n.FRAMEBUFFER]=ue),U===n.FRAMEBUFFER&&(d[n.DRAW_FRAMEBUFFER]=ue),!0):!1}function Pe(U,ue){let j=m,pe=!1;if(U){j=p.get(ue),j===void 0&&(j=[],p.set(ue,j));const xe=U.textures;if(j.length!==xe.length||j[0]!==n.COLOR_ATTACHMENT0){for(let re=0,Ee=xe.length;re<Ee;re++)j[re]=n.COLOR_ATTACHMENT0+re;j.length=xe.length,pe=!0}}else j[0]!==n.BACK&&(j[0]=n.BACK,pe=!0);pe&&n.drawBuffers(j)}function ft(U){return x!==U?(n.useProgram(U),x=U,!0):!1}const He={[bi]:n.FUNC_ADD,[Id]:n.FUNC_SUBTRACT,[Ld]:n.FUNC_REVERSE_SUBTRACT};He[Dd]=n.MIN,He[Ud]=n.MAX;const nt={[Nd]:n.ZERO,[Fd]:n.ONE,[Od]:n.SRC_COLOR,[$a]:n.SRC_ALPHA,[Vd]:n.SRC_ALPHA_SATURATE,[Gd]:n.DST_COLOR,[Bd]:n.DST_ALPHA,[kd]:n.ONE_MINUS_SRC_COLOR,[Xa]:n.ONE_MINUS_SRC_ALPHA,[Hd]:n.ONE_MINUS_DST_COLOR,[zd]:n.ONE_MINUS_DST_ALPHA,[Wd]:n.CONSTANT_COLOR,[$d]:n.ONE_MINUS_CONSTANT_COLOR,[Xd]:n.CONSTANT_ALPHA,[qd]:n.ONE_MINUS_CONSTANT_ALPHA};function Ze(U,ue,j,pe,xe,re,Ee,ye,ut,at){if(U===Wn){g===!0&&(Re(n.BLEND),g=!1);return}if(g===!1&&(ae(n.BLEND),g=!0),U!==Pd){if(U!==h||at!==I){if((w!==bi||R!==bi)&&(n.blendEquation(n.FUNC_ADD),w=bi,R=bi),at)switch(U){case as:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case wl:n.blendFunc(n.ONE,n.ONE);break;case Rl:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Cl:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:Xe("WebGLState: Invalid blending: ",U);break}else switch(U){case as:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case wl:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case Rl:Xe("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Cl:Xe("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Xe("WebGLState: Invalid blending: ",U);break}P=null,b=null,A=null,C=null,v.set(0,0,0),T=0,h=U,I=at}return}xe=xe||ue,re=re||j,Ee=Ee||pe,(ue!==w||xe!==R)&&(n.blendEquationSeparate(He[ue],He[xe]),w=ue,R=xe),(j!==P||pe!==b||re!==A||Ee!==C)&&(n.blendFuncSeparate(nt[j],nt[pe],nt[re],nt[Ee]),P=j,b=pe,A=re,C=Ee),(ye.equals(v)===!1||ut!==T)&&(n.blendColor(ye.r,ye.g,ye.b,ut),v.copy(ye),T=ut),h=U,I=!1}function Ye(U,ue){U.side===Bn?Re(n.CULL_FACE):ae(n.CULL_FACE);let j=U.side===Wt;ue&&(j=!j),gt(j),U.blending===as&&U.transparent===!1?Ze(Wn):Ze(U.blending,U.blendEquation,U.blendSrc,U.blendDst,U.blendEquationAlpha,U.blendSrcAlpha,U.blendDstAlpha,U.blendColor,U.blendAlpha,U.premultipliedAlpha),a.setFunc(U.depthFunc),a.setTest(U.depthTest),a.setMask(U.depthWrite),r.setMask(U.colorWrite);const pe=U.stencilWrite;o.setTest(pe),pe&&(o.setMask(U.stencilWriteMask),o.setFunc(U.stencilFunc,U.stencilRef,U.stencilFuncMask),o.setOp(U.stencilFail,U.stencilZFail,U.stencilZPass)),Rt(U.polygonOffset,U.polygonOffsetFactor,U.polygonOffsetUnits),U.alphaToCoverage===!0?ae(n.SAMPLE_ALPHA_TO_COVERAGE):Re(n.SAMPLE_ALPHA_TO_COVERAGE)}function gt(U){D!==U&&(U?n.frontFace(n.CW):n.frontFace(n.CCW),D=U)}function xt(U){U!==Rd?(ae(n.CULL_FACE),U!==N&&(U===Al?n.cullFace(n.BACK):U===Cd?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):Re(n.CULL_FACE),N=U}function Et(U){U!==Y&&(X&&n.lineWidth(U),Y=U)}function Rt(U,ue,j){U?(ae(n.POLYGON_OFFSET_FILL),(Q!==ue||H!==j)&&(Q=ue,H=j,a.getReversed()&&(ue=-ue),n.polygonOffset(ue,j))):Re(n.POLYGON_OFFSET_FILL)}function ct(U){U?ae(n.SCISSOR_TEST):Re(n.SCISSOR_TEST)}function _t(U){U===void 0&&(U=n.TEXTURE0+J-1),k!==U&&(n.activeTexture(U),k=U)}function F(U,ue,j){j===void 0&&(k===null?j=n.TEXTURE0+J-1:j=k);let pe=B[j];pe===void 0&&(pe={type:void 0,texture:void 0},B[j]=pe),(pe.type!==U||pe.texture!==ue)&&(k!==j&&(n.activeTexture(j),k=j),n.bindTexture(U,ue||ne[U]),pe.type=U,pe.texture=ue)}function zt(){const U=B[k];U!==void 0&&U.type!==void 0&&(n.bindTexture(U.type,null),U.type=void 0,U.texture=void 0)}function je(){try{n.compressedTexImage2D(...arguments)}catch(U){Xe("WebGLState:",U)}}function y(){try{n.compressedTexImage3D(...arguments)}catch(U){Xe("WebGLState:",U)}}function _(){try{n.texSubImage2D(...arguments)}catch(U){Xe("WebGLState:",U)}}function z(){try{n.texSubImage3D(...arguments)}catch(U){Xe("WebGLState:",U)}}function $(){try{n.compressedTexSubImage2D(...arguments)}catch(U){Xe("WebGLState:",U)}}function K(){try{n.compressedTexSubImage3D(...arguments)}catch(U){Xe("WebGLState:",U)}}function le(){try{n.texStorage2D(...arguments)}catch(U){Xe("WebGLState:",U)}}function de(){try{n.texStorage3D(...arguments)}catch(U){Xe("WebGLState:",U)}}function Z(){try{n.texImage2D(...arguments)}catch(U){Xe("WebGLState:",U)}}function te(){try{n.texImage3D(...arguments)}catch(U){Xe("WebGLState:",U)}}function fe(U){return f[U]!==void 0?f[U]:n.getParameter(U)}function Te(U,ue){f[U]!==ue&&(n.pixelStorei(U,ue),f[U]=ue)}function me(U){Le.equals(U)===!1&&(n.scissor(U.x,U.y,U.z,U.w),Le.copy(U))}function he(U){ce.equals(U)===!1&&(n.viewport(U.x,U.y,U.z,U.w),ce.copy(U))}function Ce(U,ue){let j=c.get(ue);j===void 0&&(j=new WeakMap,c.set(ue,j));let pe=j.get(U);pe===void 0&&(pe=n.getUniformBlockIndex(ue,U.name),j.set(U,pe))}function Ie(U,ue){const pe=c.get(ue).get(U);l.get(ue)!==pe&&(n.uniformBlockBinding(ue,pe,U.__bindingPointIndex),l.set(ue,pe))}function Fe(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),a.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),n.pixelStorei(n.PACK_ALIGNMENT,4),n.pixelStorei(n.UNPACK_ALIGNMENT,4),n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,!1),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,n.BROWSER_DEFAULT_WEBGL),n.pixelStorei(n.PACK_ROW_LENGTH,0),n.pixelStorei(n.PACK_SKIP_PIXELS,0),n.pixelStorei(n.PACK_SKIP_ROWS,0),n.pixelStorei(n.UNPACK_ROW_LENGTH,0),n.pixelStorei(n.UNPACK_IMAGE_HEIGHT,0),n.pixelStorei(n.UNPACK_SKIP_PIXELS,0),n.pixelStorei(n.UNPACK_SKIP_ROWS,0),n.pixelStorei(n.UNPACK_SKIP_IMAGES,0),u={},f={},k=null,B={},d={},p=new WeakMap,m=[],x=null,g=!1,h=null,w=null,P=null,b=null,R=null,A=null,C=null,v=new qe(0,0,0),T=0,I=!1,D=null,N=null,Y=null,Q=null,H=null,Le.set(0,0,n.canvas.width,n.canvas.height),ce.set(0,0,n.canvas.width,n.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:ae,disable:Re,bindFramebuffer:Ne,drawBuffers:Pe,useProgram:ft,setBlending:Ze,setMaterial:Ye,setFlipSided:gt,setCullFace:xt,setLineWidth:Et,setPolygonOffset:Rt,setScissorTest:ct,activeTexture:_t,bindTexture:F,unbindTexture:zt,compressedTexImage2D:je,compressedTexImage3D:y,texImage2D:Z,texImage3D:te,pixelStorei:Te,getParameter:fe,updateUBOMapping:Ce,uniformBlockBinding:Ie,texStorage2D:le,texStorage3D:de,texSubImage2D:_,texSubImage3D:z,compressedTexSubImage2D:$,compressedTexSubImage3D:K,scissor:me,viewport:he,reset:Fe}}function Dg(n,e,t,i,s,r,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Ve,u=new WeakMap,f=new Set;let d;const p=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function x(y,_){return m?new OffscreenCanvas(y,_):Nr("canvas")}function g(y,_,z){let $=1;const K=je(y);if((K.width>z||K.height>z)&&($=z/Math.max(K.width,K.height)),$<1)if(typeof HTMLImageElement<"u"&&y instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&y instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&y instanceof ImageBitmap||typeof VideoFrame<"u"&&y instanceof VideoFrame){const le=Math.floor($*K.width),de=Math.floor($*K.height);d===void 0&&(d=x(le,de));const Z=_?x(le,de):d;return Z.width=le,Z.height=de,Z.getContext("2d").drawImage(y,0,0,le,de),De("WebGLRenderer: Texture has been resized from ("+K.width+"x"+K.height+") to ("+le+"x"+de+")."),Z}else return"data"in y&&De("WebGLRenderer: Image in DataTexture is too big ("+K.width+"x"+K.height+")."),y;return y}function h(y){return y.generateMipmaps}function w(y){n.generateMipmap(y)}function P(y){return y.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:y.isWebGL3DRenderTarget?n.TEXTURE_3D:y.isWebGLArrayRenderTarget||y.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function b(y,_,z,$,K,le=!1){if(y!==null){if(n[y]!==void 0)return n[y];De("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+y+"'")}let de;$&&(de=e.get("EXT_texture_norm16"),de||De("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let Z=_;if(_===n.RED&&(z===n.FLOAT&&(Z=n.R32F),z===n.HALF_FLOAT&&(Z=n.R16F),z===n.UNSIGNED_BYTE&&(Z=n.R8),z===n.UNSIGNED_SHORT&&de&&(Z=de.R16_EXT),z===n.SHORT&&de&&(Z=de.R16_SNORM_EXT)),_===n.RED_INTEGER&&(z===n.UNSIGNED_BYTE&&(Z=n.R8UI),z===n.UNSIGNED_SHORT&&(Z=n.R16UI),z===n.UNSIGNED_INT&&(Z=n.R32UI),z===n.BYTE&&(Z=n.R8I),z===n.SHORT&&(Z=n.R16I),z===n.INT&&(Z=n.R32I)),_===n.RG&&(z===n.FLOAT&&(Z=n.RG32F),z===n.HALF_FLOAT&&(Z=n.RG16F),z===n.UNSIGNED_BYTE&&(Z=n.RG8),z===n.UNSIGNED_SHORT&&de&&(Z=de.RG16_EXT),z===n.SHORT&&de&&(Z=de.RG16_SNORM_EXT)),_===n.RG_INTEGER&&(z===n.UNSIGNED_BYTE&&(Z=n.RG8UI),z===n.UNSIGNED_SHORT&&(Z=n.RG16UI),z===n.UNSIGNED_INT&&(Z=n.RG32UI),z===n.BYTE&&(Z=n.RG8I),z===n.SHORT&&(Z=n.RG16I),z===n.INT&&(Z=n.RG32I)),_===n.RGB_INTEGER&&(z===n.UNSIGNED_BYTE&&(Z=n.RGB8UI),z===n.UNSIGNED_SHORT&&(Z=n.RGB16UI),z===n.UNSIGNED_INT&&(Z=n.RGB32UI),z===n.BYTE&&(Z=n.RGB8I),z===n.SHORT&&(Z=n.RGB16I),z===n.INT&&(Z=n.RGB32I)),_===n.RGBA_INTEGER&&(z===n.UNSIGNED_BYTE&&(Z=n.RGBA8UI),z===n.UNSIGNED_SHORT&&(Z=n.RGBA16UI),z===n.UNSIGNED_INT&&(Z=n.RGBA32UI),z===n.BYTE&&(Z=n.RGBA8I),z===n.SHORT&&(Z=n.RGBA16I),z===n.INT&&(Z=n.RGBA32I)),_===n.RGB&&(z===n.UNSIGNED_SHORT&&de&&(Z=de.RGB16_EXT),z===n.SHORT&&de&&(Z=de.RGB16_SNORM_EXT),z===n.UNSIGNED_INT_5_9_9_9_REV&&(Z=n.RGB9_E5),z===n.UNSIGNED_INT_10F_11F_11F_REV&&(Z=n.R11F_G11F_B10F)),_===n.RGBA){const te=le?Ur:We.getTransfer(K);z===n.FLOAT&&(Z=n.RGBA32F),z===n.HALF_FLOAT&&(Z=n.RGBA16F),z===n.UNSIGNED_BYTE&&(Z=te===et?n.SRGB8_ALPHA8:n.RGBA8),z===n.UNSIGNED_SHORT&&de&&(Z=de.RGBA16_EXT),z===n.SHORT&&de&&(Z=de.RGBA16_SNORM_EXT),z===n.UNSIGNED_SHORT_4_4_4_4&&(Z=n.RGBA4),z===n.UNSIGNED_SHORT_5_5_5_1&&(Z=n.RGB5_A1)}return(Z===n.R16F||Z===n.R32F||Z===n.RG16F||Z===n.RG32F||Z===n.RGBA16F||Z===n.RGBA32F)&&e.get("EXT_color_buffer_float"),Z}function R(y,_){let z;return y?_===null||_===Pn||_===Os?z=n.DEPTH24_STENCIL8:_===cn?z=n.DEPTH32F_STENCIL8:_===Fs&&(z=n.DEPTH24_STENCIL8,De("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===Pn||_===Os?z=n.DEPTH_COMPONENT24:_===cn?z=n.DEPTH_COMPONENT32F:_===Fs&&(z=n.DEPTH_COMPONENT16),z}function A(y,_){return h(y)===!0||y.isFramebufferTexture&&y.minFilter!==Ct&&y.minFilter!==Ut?Math.log2(Math.max(_.width,_.height))+1:y.mipmaps!==void 0&&y.mipmaps.length>0?y.mipmaps.length:y.isCompressedTexture&&Array.isArray(y.image)?_.mipmaps.length:1}function C(y){const _=y.target;_.removeEventListener("dispose",C),T(_),_.isVideoTexture&&u.delete(_),_.isHTMLTexture&&f.delete(_)}function v(y){const _=y.target;_.removeEventListener("dispose",v),D(_)}function T(y){const _=i.get(y);if(_.__webglInit===void 0)return;const z=y.source,$=p.get(z);if($){const K=$[_.__cacheKey];K.usedTimes--,K.usedTimes===0&&I(y),Object.keys($).length===0&&p.delete(z)}i.remove(y)}function I(y){const _=i.get(y);n.deleteTexture(_.__webglTexture);const z=y.source,$=p.get(z);delete $[_.__cacheKey],a.memory.textures--}function D(y){const _=i.get(y);if(y.depthTexture&&(y.depthTexture.dispose(),i.remove(y.depthTexture)),y.isWebGLCubeRenderTarget)for(let $=0;$<6;$++){if(Array.isArray(_.__webglFramebuffer[$]))for(let K=0;K<_.__webglFramebuffer[$].length;K++)n.deleteFramebuffer(_.__webglFramebuffer[$][K]);else n.deleteFramebuffer(_.__webglFramebuffer[$]);_.__webglDepthbuffer&&n.deleteRenderbuffer(_.__webglDepthbuffer[$])}else{if(Array.isArray(_.__webglFramebuffer))for(let $=0;$<_.__webglFramebuffer.length;$++)n.deleteFramebuffer(_.__webglFramebuffer[$]);else n.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&n.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&n.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let $=0;$<_.__webglColorRenderbuffer.length;$++)_.__webglColorRenderbuffer[$]&&n.deleteRenderbuffer(_.__webglColorRenderbuffer[$]);_.__webglDepthRenderbuffer&&n.deleteRenderbuffer(_.__webglDepthRenderbuffer)}const z=y.textures;for(let $=0,K=z.length;$<K;$++){const le=i.get(z[$]);le.__webglTexture&&(n.deleteTexture(le.__webglTexture),a.memory.textures--),i.remove(z[$])}i.remove(y)}let N=0;function Y(){N=0}function Q(){return N}function H(y){N=y}function J(){const y=N;return y>=s.maxTextures&&De("WebGLTextures: Trying to use "+y+" texture units while this GPU supports only "+s.maxTextures),N+=1,y}function X(y){const _=[];return _.push(y.wrapS),_.push(y.wrapT),_.push(y.wrapR||0),_.push(y.magFilter),_.push(y.minFilter),_.push(y.anisotropy),_.push(y.internalFormat),_.push(y.format),_.push(y.type),_.push(y.generateMipmaps),_.push(y.premultiplyAlpha),_.push(y.flipY),_.push(y.unpackAlignment),_.push(y.colorSpace),_.join()}function ie(y,_){const z=i.get(y);if(y.isVideoTexture&&F(y),y.isRenderTargetTexture===!1&&y.isExternalTexture!==!0&&y.version>0&&z.__version!==y.version){const $=y.image;if($===null)De("WebGLRenderer: Texture marked for update but no image data found.");else if($.complete===!1)De("WebGLRenderer: Texture marked for update but image is incomplete");else{Re(z,y,_);return}}else y.isExternalTexture&&(z.__webglTexture=y.sourceTexture?y.sourceTexture:null);t.bindTexture(n.TEXTURE_2D,z.__webglTexture,n.TEXTURE0+_)}function oe(y,_){const z=i.get(y);if(y.isRenderTargetTexture===!1&&y.version>0&&z.__version!==y.version){Re(z,y,_);return}else y.isExternalTexture&&(z.__webglTexture=y.sourceTexture?y.sourceTexture:null);t.bindTexture(n.TEXTURE_2D_ARRAY,z.__webglTexture,n.TEXTURE0+_)}function k(y,_){const z=i.get(y);if(y.isRenderTargetTexture===!1&&y.version>0&&z.__version!==y.version){Re(z,y,_);return}t.bindTexture(n.TEXTURE_3D,z.__webglTexture,n.TEXTURE0+_)}function B(y,_){const z=i.get(y);if(y.isCubeDepthTexture!==!0&&y.version>0&&z.__version!==y.version){Ne(z,y,_);return}t.bindTexture(n.TEXTURE_CUBE_MAP,z.__webglTexture,n.TEXTURE0+_)}const E={[Pr]:n.REPEAT,[Hn]:n.CLAMP_TO_EDGE,[eo]:n.MIRRORED_REPEAT},se={[Ct]:n.NEAREST,[Zd]:n.NEAREST_MIPMAP_NEAREST,[Zs]:n.NEAREST_MIPMAP_LINEAR,[Ut]:n.LINEAR,[Qr]:n.LINEAR_MIPMAP_NEAREST,[Ti]:n.LINEAR_MIPMAP_LINEAR},Le={[jd]:n.NEVER,[rf]:n.ALWAYS,[ef]:n.LESS,[nl]:n.LEQUAL,[tf]:n.EQUAL,[il]:n.GEQUAL,[nf]:n.GREATER,[sf]:n.NOTEQUAL};function ce(y,_){if(_.type===cn&&e.has("OES_texture_float_linear")===!1&&(_.magFilter===Ut||_.magFilter===Qr||_.magFilter===Zs||_.magFilter===Ti||_.minFilter===Ut||_.minFilter===Qr||_.minFilter===Zs||_.minFilter===Ti)&&De("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(y,n.TEXTURE_WRAP_S,E[_.wrapS]),n.texParameteri(y,n.TEXTURE_WRAP_T,E[_.wrapT]),(y===n.TEXTURE_3D||y===n.TEXTURE_2D_ARRAY)&&n.texParameteri(y,n.TEXTURE_WRAP_R,E[_.wrapR]),n.texParameteri(y,n.TEXTURE_MAG_FILTER,se[_.magFilter]),n.texParameteri(y,n.TEXTURE_MIN_FILTER,se[_.minFilter]),_.compareFunction&&(n.texParameteri(y,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(y,n.TEXTURE_COMPARE_FUNC,Le[_.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===Ct||_.minFilter!==Zs&&_.minFilter!==Ti||_.type===cn&&e.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||i.get(_).__currentAnisotropy){const z=e.get("EXT_texture_filter_anisotropic");n.texParameterf(y,z.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,s.getMaxAnisotropy())),i.get(_).__currentAnisotropy=_.anisotropy}}}function ee(y,_){let z=!1;y.__webglInit===void 0&&(y.__webglInit=!0,_.addEventListener("dispose",C));const $=_.source;let K=p.get($);K===void 0&&(K={},p.set($,K));const le=X(_);if(le!==y.__cacheKey){K[le]===void 0&&(K[le]={texture:n.createTexture(),usedTimes:0},a.memory.textures++,z=!0),K[le].usedTimes++;const de=K[y.__cacheKey];de!==void 0&&(K[y.__cacheKey].usedTimes--,de.usedTimes===0&&I(_)),y.__cacheKey=le,y.__webglTexture=K[le].texture}return z}function ne(y,_,z){return Math.floor(Math.floor(y/z)/_)}function ae(y,_,z,$){const le=y.updateRanges;if(le.length===0)t.texSubImage2D(n.TEXTURE_2D,0,0,0,_.width,_.height,z,$,_.data);else{le.sort((Te,me)=>Te.start-me.start);let de=0;for(let Te=1;Te<le.length;Te++){const me=le[de],he=le[Te],Ce=me.start+me.count,Ie=ne(he.start,_.width,4),Fe=ne(me.start,_.width,4);he.start<=Ce+1&&Ie===Fe&&ne(he.start+he.count-1,_.width,4)===Ie?me.count=Math.max(me.count,he.start+he.count-me.start):(++de,le[de]=he)}le.length=de+1;const Z=t.getParameter(n.UNPACK_ROW_LENGTH),te=t.getParameter(n.UNPACK_SKIP_PIXELS),fe=t.getParameter(n.UNPACK_SKIP_ROWS);t.pixelStorei(n.UNPACK_ROW_LENGTH,_.width);for(let Te=0,me=le.length;Te<me;Te++){const he=le[Te],Ce=Math.floor(he.start/4),Ie=Math.ceil(he.count/4),Fe=Ce%_.width,U=Math.floor(Ce/_.width),ue=Ie,j=1;t.pixelStorei(n.UNPACK_SKIP_PIXELS,Fe),t.pixelStorei(n.UNPACK_SKIP_ROWS,U),t.texSubImage2D(n.TEXTURE_2D,0,Fe,U,ue,j,z,$,_.data)}y.clearUpdateRanges(),t.pixelStorei(n.UNPACK_ROW_LENGTH,Z),t.pixelStorei(n.UNPACK_SKIP_PIXELS,te),t.pixelStorei(n.UNPACK_SKIP_ROWS,fe)}}function Re(y,_,z){let $=n.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&($=n.TEXTURE_2D_ARRAY),_.isData3DTexture&&($=n.TEXTURE_3D);const K=ee(y,_),le=_.source;t.bindTexture($,y.__webglTexture,n.TEXTURE0+z);const de=i.get(le);if(le.version!==de.__version||K===!0){if(t.activeTexture(n.TEXTURE0+z),(typeof ImageBitmap<"u"&&_.image instanceof ImageBitmap)===!1){const j=We.getPrimaries(We.workingColorSpace),pe=_.colorSpace===ci?null:We.getPrimaries(_.colorSpace),xe=_.colorSpace===ci||j===pe?n.NONE:n.BROWSER_DEFAULT_WEBGL;t.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,_.flipY),t.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),t.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,xe)}t.pixelStorei(n.UNPACK_ALIGNMENT,_.unpackAlignment);let te=g(_.image,!1,s.maxTextureSize);te=zt(_,te);const fe=r.convert(_.format,_.colorSpace),Te=r.convert(_.type);let me=b(_.internalFormat,fe,Te,_.normalized,_.colorSpace,_.isVideoTexture);ce($,_);let he;const Ce=_.mipmaps,Ie=_.isVideoTexture!==!0,Fe=de.__version===void 0||K===!0,U=le.dataReady,ue=A(_,te);if(_.isDepthTexture)me=R(_.format===Ai,_.type),Fe&&(Ie?t.texStorage2D(n.TEXTURE_2D,1,me,te.width,te.height):t.texImage2D(n.TEXTURE_2D,0,me,te.width,te.height,0,fe,Te,null));else if(_.isDataTexture)if(Ce.length>0){Ie&&Fe&&t.texStorage2D(n.TEXTURE_2D,ue,me,Ce[0].width,Ce[0].height);for(let j=0,pe=Ce.length;j<pe;j++)he=Ce[j],Ie?U&&t.texSubImage2D(n.TEXTURE_2D,j,0,0,he.width,he.height,fe,Te,he.data):t.texImage2D(n.TEXTURE_2D,j,me,he.width,he.height,0,fe,Te,he.data);_.generateMipmaps=!1}else Ie?(Fe&&t.texStorage2D(n.TEXTURE_2D,ue,me,te.width,te.height),U&&ae(_,te,fe,Te)):t.texImage2D(n.TEXTURE_2D,0,me,te.width,te.height,0,fe,Te,te.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){Ie&&Fe&&t.texStorage3D(n.TEXTURE_2D_ARRAY,ue,me,Ce[0].width,Ce[0].height,te.depth);for(let j=0,pe=Ce.length;j<pe;j++)if(he=Ce[j],_.format!==un)if(fe!==null)if(Ie){if(U)if(_.layerUpdates.size>0){const xe=rc(he.width,he.height,_.format,_.type);for(const re of _.layerUpdates){const Ee=he.data.subarray(re*xe/he.data.BYTES_PER_ELEMENT,(re+1)*xe/he.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,j,0,0,re,he.width,he.height,1,fe,Ee)}_.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,j,0,0,0,he.width,he.height,te.depth,fe,he.data)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,j,me,he.width,he.height,te.depth,0,he.data,0,0);else De("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ie?U&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,j,0,0,0,he.width,he.height,te.depth,fe,Te,he.data):t.texImage3D(n.TEXTURE_2D_ARRAY,j,me,he.width,he.height,te.depth,0,fe,Te,he.data)}else{Ie&&Fe&&t.texStorage2D(n.TEXTURE_2D,ue,me,Ce[0].width,Ce[0].height);for(let j=0,pe=Ce.length;j<pe;j++)he=Ce[j],_.format!==un?fe!==null?Ie?U&&t.compressedTexSubImage2D(n.TEXTURE_2D,j,0,0,he.width,he.height,fe,he.data):t.compressedTexImage2D(n.TEXTURE_2D,j,me,he.width,he.height,0,he.data):De("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ie?U&&t.texSubImage2D(n.TEXTURE_2D,j,0,0,he.width,he.height,fe,Te,he.data):t.texImage2D(n.TEXTURE_2D,j,me,he.width,he.height,0,fe,Te,he.data)}else if(_.isDataArrayTexture)if(Ie){if(Fe&&t.texStorage3D(n.TEXTURE_2D_ARRAY,ue,me,te.width,te.height,te.depth),U)if(_.layerUpdates.size>0){const j=rc(te.width,te.height,_.format,_.type);for(const pe of _.layerUpdates){const xe=te.data.subarray(pe*j/te.data.BYTES_PER_ELEMENT,(pe+1)*j/te.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,pe,te.width,te.height,1,fe,Te,xe)}_.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,te.width,te.height,te.depth,fe,Te,te.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,me,te.width,te.height,te.depth,0,fe,Te,te.data);else if(_.isData3DTexture)Ie?(Fe&&t.texStorage3D(n.TEXTURE_3D,ue,me,te.width,te.height,te.depth),U&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,te.width,te.height,te.depth,fe,Te,te.data)):t.texImage3D(n.TEXTURE_3D,0,me,te.width,te.height,te.depth,0,fe,Te,te.data);else if(_.isFramebufferTexture){if(Fe)if(Ie)t.texStorage2D(n.TEXTURE_2D,ue,me,te.width,te.height);else{let j=te.width,pe=te.height;for(let xe=0;xe<ue;xe++)t.texImage2D(n.TEXTURE_2D,xe,me,j,pe,0,fe,Te,null),j>>=1,pe>>=1}}else if(_.isHTMLTexture){if("texElementImage2D"in n){const j=n.canvas;if(j.hasAttribute("layoutsubtree")||j.setAttribute("layoutsubtree","true"),te.parentNode!==j){j.appendChild(te),f.add(_),j.onpaint=pe=>{const xe=pe.changedElements;for(const re of f)xe.includes(re.image)&&(re.needsUpdate=!0)},j.requestPaint();return}if(n.texElementImage2D.length===3)n.texElementImage2D(n.TEXTURE_2D,n.RGBA8,te);else{const xe=n.RGBA,re=n.RGBA,Ee=n.UNSIGNED_BYTE;n.texElementImage2D(n.TEXTURE_2D,0,xe,re,Ee,te)}n.texParameteri(n.TEXTURE_2D,n.TEXTURE_MIN_FILTER,n.LINEAR),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_S,n.CLAMP_TO_EDGE),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_T,n.CLAMP_TO_EDGE)}}else if(Ce.length>0){if(Ie&&Fe){const j=je(Ce[0]);t.texStorage2D(n.TEXTURE_2D,ue,me,j.width,j.height)}for(let j=0,pe=Ce.length;j<pe;j++)he=Ce[j],Ie?U&&t.texSubImage2D(n.TEXTURE_2D,j,0,0,fe,Te,he):t.texImage2D(n.TEXTURE_2D,j,me,fe,Te,he);_.generateMipmaps=!1}else if(Ie){if(Fe){const j=je(te);t.texStorage2D(n.TEXTURE_2D,ue,me,j.width,j.height)}U&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,fe,Te,te)}else t.texImage2D(n.TEXTURE_2D,0,me,fe,Te,te);h(_)&&w($),de.__version=le.version,_.onUpdate&&_.onUpdate(_)}y.__version=_.version}function Ne(y,_,z){if(_.image.length!==6)return;const $=ee(y,_),K=_.source;t.bindTexture(n.TEXTURE_CUBE_MAP,y.__webglTexture,n.TEXTURE0+z);const le=i.get(K);if(K.version!==le.__version||$===!0){t.activeTexture(n.TEXTURE0+z);const de=We.getPrimaries(We.workingColorSpace),Z=_.colorSpace===ci?null:We.getPrimaries(_.colorSpace),te=_.colorSpace===ci||de===Z?n.NONE:n.BROWSER_DEFAULT_WEBGL;t.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,_.flipY),t.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),t.pixelStorei(n.UNPACK_ALIGNMENT,_.unpackAlignment),t.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,te);const fe=_.isCompressedTexture||_.image[0].isCompressedTexture,Te=_.image[0]&&_.image[0].isDataTexture,me=[];for(let re=0;re<6;re++)!fe&&!Te?me[re]=g(_.image[re],!0,s.maxCubemapSize):me[re]=Te?_.image[re].image:_.image[re],me[re]=zt(_,me[re]);const he=me[0],Ce=r.convert(_.format,_.colorSpace),Ie=r.convert(_.type),Fe=b(_.internalFormat,Ce,Ie,_.normalized,_.colorSpace),U=_.isVideoTexture!==!0,ue=le.__version===void 0||$===!0,j=K.dataReady;let pe=A(_,he);ce(n.TEXTURE_CUBE_MAP,_);let xe;if(fe){U&&ue&&t.texStorage2D(n.TEXTURE_CUBE_MAP,pe,Fe,he.width,he.height);for(let re=0;re<6;re++){xe=me[re].mipmaps;for(let Ee=0;Ee<xe.length;Ee++){const ye=xe[Ee];_.format!==un?Ce!==null?U?j&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+re,Ee,0,0,ye.width,ye.height,Ce,ye.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+re,Ee,Fe,ye.width,ye.height,0,ye.data):De("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):U?j&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+re,Ee,0,0,ye.width,ye.height,Ce,Ie,ye.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+re,Ee,Fe,ye.width,ye.height,0,Ce,Ie,ye.data)}}}else{if(xe=_.mipmaps,U&&ue){xe.length>0&&pe++;const re=je(me[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,pe,Fe,re.width,re.height)}for(let re=0;re<6;re++)if(Te){U?j&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+re,0,0,0,me[re].width,me[re].height,Ce,Ie,me[re].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+re,0,Fe,me[re].width,me[re].height,0,Ce,Ie,me[re].data);for(let Ee=0;Ee<xe.length;Ee++){const ut=xe[Ee].image[re].image;U?j&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+re,Ee+1,0,0,ut.width,ut.height,Ce,Ie,ut.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+re,Ee+1,Fe,ut.width,ut.height,0,Ce,Ie,ut.data)}}else{U?j&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+re,0,0,0,Ce,Ie,me[re]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+re,0,Fe,Ce,Ie,me[re]);for(let Ee=0;Ee<xe.length;Ee++){const ye=xe[Ee];U?j&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+re,Ee+1,0,0,Ce,Ie,ye.image[re]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+re,Ee+1,Fe,Ce,Ie,ye.image[re])}}}h(_)&&w(n.TEXTURE_CUBE_MAP),le.__version=K.version,_.onUpdate&&_.onUpdate(_)}y.__version=_.version}function Pe(y,_,z,$,K,le){const de=r.convert(z.format,z.colorSpace),Z=r.convert(z.type),te=b(z.internalFormat,de,Z,z.normalized,z.colorSpace),fe=i.get(_),Te=i.get(z);if(Te.__renderTarget=_,!fe.__hasExternalTextures){const me=Math.max(1,_.width>>le),he=Math.max(1,_.height>>le);K===n.TEXTURE_3D||K===n.TEXTURE_2D_ARRAY?t.texImage3D(K,le,te,me,he,_.depth,0,de,Z,null):t.texImage2D(K,le,te,me,he,0,de,Z,null)}t.bindFramebuffer(n.FRAMEBUFFER,y),_t(_)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,$,K,Te.__webglTexture,0,ct(_)):(K===n.TEXTURE_2D||K>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&K<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,$,K,Te.__webglTexture,le),t.bindFramebuffer(n.FRAMEBUFFER,null)}function ft(y,_,z){if(n.bindRenderbuffer(n.RENDERBUFFER,y),_.depthBuffer){const $=_.depthTexture,K=$&&$.isDepthTexture?$.type:null,le=R(_.stencilBuffer,K),de=_.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;_t(_)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,ct(_),le,_.width,_.height):z?n.renderbufferStorageMultisample(n.RENDERBUFFER,ct(_),le,_.width,_.height):n.renderbufferStorage(n.RENDERBUFFER,le,_.width,_.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,de,n.RENDERBUFFER,y)}else{const $=_.textures;for(let K=0;K<$.length;K++){const le=$[K],de=r.convert(le.format,le.colorSpace),Z=r.convert(le.type),te=b(le.internalFormat,de,Z,le.normalized,le.colorSpace);_t(_)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,ct(_),te,_.width,_.height):z?n.renderbufferStorageMultisample(n.RENDERBUFFER,ct(_),te,_.width,_.height):n.renderbufferStorage(n.RENDERBUFFER,te,_.width,_.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function He(y,_,z){const $=_.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(n.FRAMEBUFFER,y),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const K=i.get(_.depthTexture);if(K.__renderTarget=_,(!K.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),$){if(K.__webglInit===void 0&&(K.__webglInit=!0,_.depthTexture.addEventListener("dispose",C)),K.__webglTexture===void 0){K.__webglTexture=n.createTexture(),t.bindTexture(n.TEXTURE_CUBE_MAP,K.__webglTexture),ce(n.TEXTURE_CUBE_MAP,_.depthTexture);const fe=r.convert(_.depthTexture.format),Te=r.convert(_.depthTexture.type);let me;_.depthTexture.format===qn?me=n.DEPTH_COMPONENT24:_.depthTexture.format===Ai&&(me=n.DEPTH24_STENCIL8);for(let he=0;he<6;he++)n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+he,0,me,_.width,_.height,0,fe,Te,null)}}else ie(_.depthTexture,0);const le=K.__webglTexture,de=ct(_),Z=$?n.TEXTURE_CUBE_MAP_POSITIVE_X+z:n.TEXTURE_2D,te=_.depthTexture.format===Ai?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;if(_.depthTexture.format===qn)_t(_)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,te,Z,le,0,de):n.framebufferTexture2D(n.FRAMEBUFFER,te,Z,le,0);else if(_.depthTexture.format===Ai)_t(_)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,te,Z,le,0,de):n.framebufferTexture2D(n.FRAMEBUFFER,te,Z,le,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function nt(y){const _=i.get(y),z=y.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==y.depthTexture){const $=y.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),$){const K=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,$.removeEventListener("dispose",K)};$.addEventListener("dispose",K),_.__depthDisposeCallback=K}_.__boundDepthTexture=$}if(y.depthTexture&&!_.__autoAllocateDepthBuffer)if(z)for(let $=0;$<6;$++)He(_.__webglFramebuffer[$],y,$);else{const $=y.texture.mipmaps;$&&$.length>0?He(_.__webglFramebuffer[0],y,0):He(_.__webglFramebuffer,y,0)}else if(z){_.__webglDepthbuffer=[];for(let $=0;$<6;$++)if(t.bindFramebuffer(n.FRAMEBUFFER,_.__webglFramebuffer[$]),_.__webglDepthbuffer[$]===void 0)_.__webglDepthbuffer[$]=n.createRenderbuffer(),ft(_.__webglDepthbuffer[$],y,!1);else{const K=y.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,le=_.__webglDepthbuffer[$];n.bindRenderbuffer(n.RENDERBUFFER,le),n.framebufferRenderbuffer(n.FRAMEBUFFER,K,n.RENDERBUFFER,le)}}else{const $=y.texture.mipmaps;if($&&$.length>0?t.bindFramebuffer(n.FRAMEBUFFER,_.__webglFramebuffer[0]):t.bindFramebuffer(n.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=n.createRenderbuffer(),ft(_.__webglDepthbuffer,y,!1);else{const K=y.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,le=_.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,le),n.framebufferRenderbuffer(n.FRAMEBUFFER,K,n.RENDERBUFFER,le)}}t.bindFramebuffer(n.FRAMEBUFFER,null)}function Ze(y,_,z){const $=i.get(y);_!==void 0&&Pe($.__webglFramebuffer,y,y.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),z!==void 0&&nt(y)}function Ye(y){const _=y.texture,z=i.get(y),$=i.get(_);y.addEventListener("dispose",v);const K=y.textures,le=y.isWebGLCubeRenderTarget===!0,de=K.length>1;if(de||($.__webglTexture===void 0&&($.__webglTexture=n.createTexture()),$.__version=_.version,a.memory.textures++),le){z.__webglFramebuffer=[];for(let Z=0;Z<6;Z++)if(_.mipmaps&&_.mipmaps.length>0){z.__webglFramebuffer[Z]=[];for(let te=0;te<_.mipmaps.length;te++)z.__webglFramebuffer[Z][te]=n.createFramebuffer()}else z.__webglFramebuffer[Z]=n.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){z.__webglFramebuffer=[];for(let Z=0;Z<_.mipmaps.length;Z++)z.__webglFramebuffer[Z]=n.createFramebuffer()}else z.__webglFramebuffer=n.createFramebuffer();if(de)for(let Z=0,te=K.length;Z<te;Z++){const fe=i.get(K[Z]);fe.__webglTexture===void 0&&(fe.__webglTexture=n.createTexture(),a.memory.textures++)}if(y.samples>0&&_t(y)===!1){z.__webglMultisampledFramebuffer=n.createFramebuffer(),z.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,z.__webglMultisampledFramebuffer);for(let Z=0;Z<K.length;Z++){const te=K[Z];z.__webglColorRenderbuffer[Z]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,z.__webglColorRenderbuffer[Z]);const fe=r.convert(te.format,te.colorSpace),Te=r.convert(te.type),me=b(te.internalFormat,fe,Te,te.normalized,te.colorSpace,y.isXRRenderTarget===!0),he=ct(y);n.renderbufferStorageMultisample(n.RENDERBUFFER,he,me,y.width,y.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Z,n.RENDERBUFFER,z.__webglColorRenderbuffer[Z])}n.bindRenderbuffer(n.RENDERBUFFER,null),y.depthBuffer&&(z.__webglDepthRenderbuffer=n.createRenderbuffer(),ft(z.__webglDepthRenderbuffer,y,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(le){t.bindTexture(n.TEXTURE_CUBE_MAP,$.__webglTexture),ce(n.TEXTURE_CUBE_MAP,_);for(let Z=0;Z<6;Z++)if(_.mipmaps&&_.mipmaps.length>0)for(let te=0;te<_.mipmaps.length;te++)Pe(z.__webglFramebuffer[Z][te],y,_,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+Z,te);else Pe(z.__webglFramebuffer[Z],y,_,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0);h(_)&&w(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(de){for(let Z=0,te=K.length;Z<te;Z++){const fe=K[Z],Te=i.get(fe);let me=n.TEXTURE_2D;(y.isWebGL3DRenderTarget||y.isWebGLArrayRenderTarget)&&(me=y.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(me,Te.__webglTexture),ce(me,fe),Pe(z.__webglFramebuffer,y,fe,n.COLOR_ATTACHMENT0+Z,me,0),h(fe)&&w(me)}t.unbindTexture()}else{let Z=n.TEXTURE_2D;if((y.isWebGL3DRenderTarget||y.isWebGLArrayRenderTarget)&&(Z=y.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(Z,$.__webglTexture),ce(Z,_),_.mipmaps&&_.mipmaps.length>0)for(let te=0;te<_.mipmaps.length;te++)Pe(z.__webglFramebuffer[te],y,_,n.COLOR_ATTACHMENT0,Z,te);else Pe(z.__webglFramebuffer,y,_,n.COLOR_ATTACHMENT0,Z,0);h(_)&&w(Z),t.unbindTexture()}y.depthBuffer&&nt(y)}function gt(y){const _=y.textures;for(let z=0,$=_.length;z<$;z++){const K=_[z];if(h(K)){const le=P(y),de=i.get(K).__webglTexture;t.bindTexture(le,de),w(le),t.unbindTexture()}}}const xt=[],Et=[];function Rt(y){if(y.samples>0){if(_t(y)===!1){const _=y.textures,z=y.width,$=y.height;let K=n.COLOR_BUFFER_BIT;const le=y.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,de=i.get(y),Z=_.length>1;if(Z)for(let fe=0;fe<_.length;fe++)t.bindFramebuffer(n.FRAMEBUFFER,de.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+fe,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,de.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+fe,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,de.__webglMultisampledFramebuffer);const te=y.texture.mipmaps;te&&te.length>0?t.bindFramebuffer(n.DRAW_FRAMEBUFFER,de.__webglFramebuffer[0]):t.bindFramebuffer(n.DRAW_FRAMEBUFFER,de.__webglFramebuffer);for(let fe=0;fe<_.length;fe++){if(y.resolveDepthBuffer&&(y.depthBuffer&&(K|=n.DEPTH_BUFFER_BIT),y.stencilBuffer&&y.resolveStencilBuffer&&(K|=n.STENCIL_BUFFER_BIT)),Z){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,de.__webglColorRenderbuffer[fe]);const Te=i.get(_[fe]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,Te,0)}n.blitFramebuffer(0,0,z,$,0,0,z,$,K,n.NEAREST),l===!0&&(xt.length=0,Et.length=0,xt.push(n.COLOR_ATTACHMENT0+fe),y.depthBuffer&&y.resolveDepthBuffer===!1&&(xt.push(le),Et.push(le),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,Et)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,xt))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),Z)for(let fe=0;fe<_.length;fe++){t.bindFramebuffer(n.FRAMEBUFFER,de.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+fe,n.RENDERBUFFER,de.__webglColorRenderbuffer[fe]);const Te=i.get(_[fe]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,de.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+fe,n.TEXTURE_2D,Te,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,de.__webglMultisampledFramebuffer)}else if(y.depthBuffer&&y.resolveDepthBuffer===!1&&l){const _=y.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[_])}}}function ct(y){return Math.min(s.maxSamples,y.samples)}function _t(y){const _=i.get(y);return y.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function F(y){const _=a.render.frame;u.get(y)!==_&&(u.set(y,_),y.update())}function zt(y,_){const z=y.colorSpace,$=y.format,K=y.type;return y.isCompressedTexture===!0||y.isVideoTexture===!0||z!==Dr&&z!==ci&&(We.getTransfer(z)===et?($!==un||K!==Kt)&&De("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Xe("WebGLTextures: Unsupported texture color space:",z)),_}function je(y){return typeof HTMLImageElement<"u"&&y instanceof HTMLImageElement?(c.width=y.naturalWidth||y.width,c.height=y.naturalHeight||y.height):typeof VideoFrame<"u"&&y instanceof VideoFrame?(c.width=y.displayWidth,c.height=y.displayHeight):(c.width=y.width,c.height=y.height),c}this.allocateTextureUnit=J,this.resetTextureUnits=Y,this.getTextureUnits=Q,this.setTextureUnits=H,this.setTexture2D=ie,this.setTexture2DArray=oe,this.setTexture3D=k,this.setTextureCube=B,this.rebindTextures=Ze,this.setupRenderTarget=Ye,this.updateRenderTargetMipmap=gt,this.updateMultisampleRenderTarget=Rt,this.setupDepthRenderbuffer=nt,this.setupFrameBufferTexture=Pe,this.useMultisampledRTT=_t,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function Ug(n,e){function t(i,s=ci){let r;const a=We.getTransfer(s);if(i===Kt)return n.UNSIGNED_BYTE;if(i===Zo)return n.UNSIGNED_SHORT_4_4_4_4;if(i===Jo)return n.UNSIGNED_SHORT_5_5_5_1;if(i===cu)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===uu)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===ou)return n.BYTE;if(i===lu)return n.SHORT;if(i===Fs)return n.UNSIGNED_SHORT;if(i===Ko)return n.INT;if(i===Pn)return n.UNSIGNED_INT;if(i===cn)return n.FLOAT;if(i===Xn)return n.HALF_FLOAT;if(i===du)return n.ALPHA;if(i===fu)return n.RGB;if(i===un)return n.RGBA;if(i===qn)return n.DEPTH_COMPONENT;if(i===Ai)return n.DEPTH_STENCIL;if(i===Qo)return n.RED;if(i===jo)return n.RED_INTEGER;if(i===Pi)return n.RG;if(i===el)return n.RG_INTEGER;if(i===tl)return n.RGBA_INTEGER;if(i===br||i===yr||i===Sr||i===Er)if(a===et)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(i===br)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===yr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Sr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Er)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(i===br)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===yr)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Sr)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Er)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===to||i===no||i===io||i===so)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(i===to)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===no)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===io)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===so)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===ro||i===ao||i===oo||i===lo||i===co||i===Ir||i===uo)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(i===ro||i===ao)return a===et?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(i===oo)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(i===lo)return r.COMPRESSED_R11_EAC;if(i===co)return r.COMPRESSED_SIGNED_R11_EAC;if(i===Ir)return r.COMPRESSED_RG11_EAC;if(i===uo)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===fo||i===ho||i===po||i===mo||i===go||i===_o||i===vo||i===xo||i===Mo||i===bo||i===yo||i===So||i===Eo||i===To)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(i===fo)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===ho)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===po)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===mo)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===go)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===_o)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===vo)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===xo)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Mo)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===bo)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===yo)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===So)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Eo)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===To)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Ao||i===wo||i===Ro)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(i===Ao)return a===et?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===wo)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Ro)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Co||i===Po||i===Lr||i===Io)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(i===Co)return r.COMPRESSED_RED_RGTC1_EXT;if(i===Po)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Lr)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Io)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Os?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}const Ng=`
void main() {
